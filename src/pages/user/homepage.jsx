...
const HomePage = () => {
  ...
  const productCategories = [
    {
      img: "https://images.jdmagicbox.com/quickquotes/images_main/elegant-saree-with-encrusted-borders-sb138140411-freesize-164462831-meho1.jpg",
      title: "Elegant Sarees",
      description:
        "A timeless collection of traditional and modern sarees crafted to enhance grace and beauty for every occasion.",
      category: "Elegant Sarees",
    },
    {
      img: "https://i.pinimg.com/736x/a9/9d/d4/a99dd4259f68e2128e0d0e7f8b5c8922.jpg",
      title: "Trendy Girl's Wear",
      description:
        "Stylish and comfortable outfits designed to make young girls shine in every moment, from casual wear to festive celebrations.",
      category: "Trendy Girls' Wear",
    },
    {
      img: "https://img.theloom.in/blog/wp-content/uploads/2024/04/thumb-15.png",
      title: "Exclusive Ethnic Ensembles",
      description:
        "Handpicked ethnic wear that blends tradition with contemporary designs, perfect for making every event special.",
      category: "Exclusive Ethnic Ensembles",
    },
  ];
          ...
          <div className="container relative z-10 mx-auto max-w-6xl px-4">
            ...
            >
              ...
              <p className="text-xl text-white/90 mb-10 leading-relaxed">
                To become a trusted name in the world of fashion, offering a
                seamless online shopping experience that combines quality,
                style, and affordability. We aim to celebrate individuality and
                tradition through a diverse range of clothing, making every
                customer feel confident and elegant.
              </p>
              <Link to="/about">
                <motion.button
                  whileHover={{ scale: 1.05 }}
